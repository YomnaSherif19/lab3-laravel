...
<h1 class="form-heading"></h1>
    ...
    <div class="main-div">
        ...
        <form id="register" method="POST" action="{{route('posts.store')}}">
            @csrf
            <div class="form-group">
                <input type="text" value="" name="title" class="form-control" id="inputEmail" placeholder="Title">
            </div>
            <div class="form-group">
                <input type="text" value="" name="body" class="form-control" id="inputPassword" placeholder="Body">
            </div>
        ...
        <button style= "background-color: #D53362; 
              ...
              font-size: 16px;"   type="submit">Create Post</button>            
             </form>
        </div>
